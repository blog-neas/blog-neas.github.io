...
![The lasto option will place the interpreter directly into the execution path](../../../img/pythonWIN1.png)
...
```{r uno, eval=FALSE, include=FALSE}
plot(rnorm(100),rnorm(100,2,4))
```

Alternatively, you can consider using an Integrated Development Environment (IDE). IDEs are softwares dedicated to programming, integrating several tools specifically designed for software development.
 ...
 * [**Pip troubleshooting**](https://www.makeuseof.com/tag/install-pip-for-python/) is pip installed correctly? follow this guide to solve (almost) any problem!
